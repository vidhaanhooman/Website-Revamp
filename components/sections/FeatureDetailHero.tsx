      ...
      <div className="mx-auto max-w-[1240px]">
        ...
        >
          ...
          <div>
            ...
            <h1 className="mt-5 max-w-3xl font-serif text-[clamp(2.25rem,4.8vw,3.75rem)] font-normal leading-[1.02] tracking-tight text-white">
              {title}
            </h1>
        ...
        {sections.map((s, i) => (
          ...
          >
            <div className="flex items-start justify-between gap-6">
              ...
              <span className="shrink-0 rounded-full border border-white/15 bg-white/[0.04] px-3 py-1 font-sans text-[10px] font-medium uppercase tracking-[0.2em] text-white/55">
                Content pending
              </span>
            </div>
      ...
      <div className="mx-auto max-w-[1240px]">
        ...
        <article className="relative overflow-hidden rounded-3xl border border-white/10 bg-white/[0.025] p-8 md:p-12">
          ...
          <div className="max-w-3xl">
            ...
            <h2 className="mt-5 font-serif text-[clamp(2rem,4.2vw,3.25rem)] font-normal leading-[1.02] tracking-tight text-white">
              {title}
            </h2>
            <p className="mt-5 max-w-xl text-[15.5px] font-medium leading-[1.6] text-white/70">
              {description}
          ...
          <ul className="mt-12 divide-y divide-white/[0.06] border-y border-white/[0.06]">
            {sections.map((s, i) => (
              ...
              >
                <span className="font-sans text-[11px] font-medium uppercase tracking-[0.24em] text-white/35">
          ...
          {visual ? (
            ...
            <div className="relative mt-10 min-h-[260px] overflow-hidden rounded-2xl border border-white/[0.06] bg-white/[0.015]">
              ...
              />
              <span className="absolute right-5 top-5 rounded-full border border-white/15 bg-white/[0.04] px-3 py-1 font-sans text-[10px] font-medium uppercase tracking-[0.2em] text-white/55">
                Content pending
              </span>
            </div>
          )}
